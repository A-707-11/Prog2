...
int main(int argc, char *argv[]) {
	 ...
	 */
	 MyTime oldTime={12,01,false}; // <--- 1:00PM in 12HRS {hours, minutes, boolean meridian}
	  MyTime newTime=convertTime(oldTime);
	  
	  displayTime12(oldTime);//i.e 1:01 PM
	  printf("\n");
	  displayTime24(newTime);//i.e 13:01 it will change to army time
